      ...
      <div class="container py-8">
        <div class="row gx-lg-8 gx-xl-12 gy-8">
          <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <h3 class="display-4 mb-7 mt-10 px-xl-11 text-center">We're supposed to have Terms & Conditions, so here they are</h3>
          </div>
          <div class="col-12">
            <h2>Website Terms of Use</h2>

            <p>Version 1.0 - June 1, 2023</p>

            <p>The Clutter Cowboys Website website located at https://cluttercowboys.com is a copyrighted work belonging to Clutter Cowboys. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
            ...
            </p><p>These terms require the use of arbitration Section 10.2 on an individual basis to resolve disputes and also limit the remedies available to you in the event of a dispute. These Terms of Use were created with the help of the <a href="https://www.termsofusegenerator.net">Terms Of Use Generator</a>.</p>
            ...
            <p><strong>Cookies and Web Beacons.</strong> Like any other website, Clutter Cowboys Website uses ‘cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
            ...
            <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief. A Notice to the Company should be sent to: 8245 S Placita Del Plantio, Tucson, AZ 85747. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally. If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding. The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
            ...
            <p>Address: 8245 S Placita Del Plantio, Tucson, AZ 85747</p>
            <p>Email: ktpdllklxyaiowmdfk@bbitq.com</p>
          </div>
        </div>
        <!--/.row -->
      </div>
      ...
      <div class="container py-14 py-md-14">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h3 class="fs-30 text-uppercase text-primary mb-3">Want a quick estimate before calling?</h3>
            <p class="lead mb-10"><b>Imagine all your junk as <span class="underline-3 style-3">refrigerator-sized</span> piles. Then change the number below.</b></p>
            <h4 class="display-6 mb-0 user-select-none">Your <i id="decrease_pile" class="uil uil-minus-circle fs-28 me-1 text-primary text-opacity-50 cursor-pointer"></i><span id="pile_number" class="underline-3 style-2 fs-40">6</span><i id="increase_pile" class="uil uil-plus-circle fs-28 ms-1 text-primary cursor-pointer"></i> piles will cost between <span id="lower_estimate" class="underline-3 style-2">$231</span> and <span id="upper_estimate" class="underline-3 style-2">$363</span>.</h4>
          </div>
          <!-- /column -->
        </div>
        <div class="d-flex align-items-center justify-content-center mt-12 main-cta-action">
          ...
          <span>for a <b>no-obligation, in-person</b> estimate (we never charge just to come out)</span>
        </div>
      </div>
      <!-- /.container -->
    </section>
` })}`;
}, "/Users/gaegeroot/Desktop/ClutterCowboys/src/pages/terms-of-use.astro");

const $$file = "/Users/gaegeroot/Desktop/ClutterCowboys/src/pages/terms-of-use.astro";
const $$url = "/terms-of-use";

export { $$TermsOfUse as default, $$file as file, $$url as url };
